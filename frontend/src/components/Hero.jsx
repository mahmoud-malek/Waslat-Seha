...
// Using Tailwind CSS, styles are written in the same file.
            ...
            <div className="lg:py-6">
              <div className="text-center lg:text-left">
                <h1 className=" text-gray-800 pt-4 dark:text-white font-bold text-4xl md:text-5xl lg:text-6xl">
                  <p className="p-3">Book Your Appointment</p>
              ...
              <p className="text-gray-600 dark:text-gray-300 mt-8 text-center lg:text-left mx-auto max-w-xl">
                Not sure what kind of checkup you need? Want to describe your condition first?
                <br />
                We’ve provided AI to help you book with the most suitable doctors for your case.
              </p>
              <div className="flex items-center gap-4 mt-8 flex-col sm:flex-row sm:w-max sm:mx-auto lg:mx-0">
                <button
                  onClick={onSearchClick}
                  className="px-7 relative text-white h-12 flex w-full sm:w-max justify-center items-center before:bg-[#3FD3D3] before:absolute before:inset-0 before:rounded-full before:transition-transform before:ease-linear hover:before:scale-105 active:before:scale-95"
                >
              ...
              <div className="flex items-center text-center flex-col sm:flex-row gap-4 sm:gap-0 mt-8 w-max mx-auto lg:mx-0">
                <div className="flex items-center -space-x-2">
                  <img
                    ...
                    width={1240}
                    alt="avatar"
                    className="w-10 h-15 rounded-full ring-1 ring-white dark:ring-gray-800 object-cover"
                  />
                  <img
                    src={girlDoctor}
                    width={1240}
